...
if __name__ == "__main__":
    ...
    psychophysics(args.sound_group, args.expt_name, args.inference_dir, args.sound_dir, results_dir, args.n_seeds, model_comparison_dir=args.model_comparison_dir)
